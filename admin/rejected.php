...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-sm-12">
                        ...
                        <table id="serviceRejectedTable" class="table table-striped">
                            <thead>
                                <th>Customer Name</th>
                                <th>Posted On</th>
                                <th>Posted By</th>
                ...
                <div class="row mt-5">
                    <div class="col col-sm-12">
                        ...
                        <table id="assetRejectedTable" class="table table-striped">
                            <thead>
                                <th>Customer Name</th>
                                <th>Posted On</th>
                                <th>Posted By</th>
    ...
    <script>
        $(document).ready(function() {
            $("#serviceRejectedTable").DataTable({
                pageLength: 5,
                lengthMenu: [5, 10, 25, 50, 100]
            });
            $("#assetRejectedTable").DataTable({
                pageLength: 5,
                lengthMenu: [5, 10, 25, 50, 100]
            });
        });
