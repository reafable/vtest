<div class='modal fade' id='view<?php echo $id?>' tabindex='-1' role='dialog' aria-labelledby='view<?php echo $id?>Label' aria-hidden='true'>
        ...
        <form method='post'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <input type='hidden' name='view_req_id' value='<?php echo $id ?>'>
